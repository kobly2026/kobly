...
// drawer com sugestões contextuais por rota + chat mock (offline). window.KoblyAIAssistant
(function () {
  ...
  function AIAssistant() {
    ...
    async function ask(text) {
      ...
      setInput('');
      setTyping(true);
      const reply = await window.KoblyAI.answerAssistant(text, store.view);
      setTyping(false);
    ...
    return (
      <React.Fragment>
        ...
        <Drawer
          ...
          subtitle={`Contexto: ${store.roleDef.label} · ${window.KoblyMockDB.routeTitle[store.view] || ''}`}
          footer={
  ...
  window.KoblyAIAssistant = AIAssistant;
})();
