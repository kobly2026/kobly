// Kobly — Central de ajuda (suporte). FAQ + acesso a vídeos + abrir chamado. window.KoblyHelp
(function () {
  const DS = window.KoblyDesignSystem_29b7f4;
  const { Card, Button, Icon } = DS;
  ...
  function KoblyHelp() {
    ...
    const a = useAsync(() => window.KoblyApi.getHelp(), []);
